...
export default {
  ...
  "e-mail no válido.": "e-mail no vàlid",
  Dirección: "Direcció",
  Mensaje: "Missatge",
  "Introduce la dirección.": "Introdueix la direcció",
  "Introduce el mensaje.": "Introdueix el missatge",
  "El formulario se ha enviado correctamente":
    "El formulari s'ha enviat correctament",
  "Se ha producido un error!": "S'ha produït un error",
  Enviar: "Enviar",
